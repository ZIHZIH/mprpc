...
PROTOBUF_CONSTEXPR ExitRequest::ExitRequest(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.name_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.pwd_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct ExitRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ExitRequestDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExitRequestDefaultTypeInternal _ExitRequest_default_instance_;
PROTOBUF_CONSTEXPR ExitResponse::ExitResponse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.errmsg_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.errcode_)*/0
  , /*decltype(_impl_.success_)*/false
...
struct ExitResponseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ExitResponseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExitResponseDefaultTypeInternal _ExitResponse_default_instance_;
}  // namespace fixbug
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitRequest, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitRequest, _impl_.pwd_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitResponse, _impl_.errcode_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitResponse, _impl_.errmsg_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ExitResponse, _impl_.success_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::LoginRequest)},
  { 8, -1, -1, sizeof(::fixbug::LoginResponse)},
  { 17, -1, -1, sizeof(::fixbug::ExitRequest)},
  { 25, -1, -1, sizeof(::fixbug::ExitResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::fixbug::_LoginRequest_default_instance_._instance,
  &::fixbug::_LoginResponse_default_instance_._instance,
  &::fixbug::_ExitRequest_default_instance_._instance,
  &::fixbug::_ExitResponse_default_instance_._instance,
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001 \001(\005\022\016\n\006errmsg\030\002 \001(\t\022\017\n\007success\030\003 \001(\0102y"
  "\n\016UserServiceRpc\0224\n\005Login\022\024.fixbug.Login"
  "Request\032\025.fixbug.LoginResponse\0221\n\004Exit\022\023"
  ".fixbug.ExitRequest\032\024.fixbug.ExitRespons"
...
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 374, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
ExitRequest::ExitRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.ExitRequest)
}
ExitRequest::ExitRequest(const ExitRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ExitRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.name_){}
    , decltype(_impl_.pwd_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.ExitRequest)
}

inline void ExitRequest::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ExitRequest::~ExitRequest() {
  // @@protoc_insertion_point(destructor:fixbug.ExitRequest)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:fixbug.ExitRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ExitRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "fixbug.ExitRequest.name"));
        } else
          goto handle_unusual;
        continue;
      // string pwd = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "fixbug.ExitRequest.pwd"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* ExitRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.ExitRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.ExitRequest)
  return target;
}

size_t ExitRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.ExitRequest)
  size_t total_size = 0;
...
void ExitRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ExitRequest*>(&to_msg);
  auto& from = static_cast<const ExitRequest&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.ExitRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.ExitRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
ExitResponse::ExitResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.ExitResponse)
}
ExitResponse::ExitResponse(const ExitResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ExitResponse* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.errmsg_){}
    , decltype(_impl_.errcode_){}
    , decltype(_impl_.success_){}
  ...
  ::memcpy(&_impl_.errcode_, &from._impl_.errcode_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.success_) -
    reinterpret_cast<char*>(&_impl_.errcode_)) + sizeof(_impl_.success_));
  // @@protoc_insertion_point(copy_constructor:fixbug.ExitResponse)
}

inline void ExitResponse::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ExitResponse::~ExitResponse() {
  // @@protoc_insertion_point(destructor:fixbug.ExitResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ExitResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.errmsg_.Destroy();
}
...
// @@protoc_insertion_point(message_clear_start:fixbug.ExitResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ExitResponse::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "fixbug.ExitResponse.errmsg"));
        } else
          goto handle_unusual;
        continue;
      // bool success = 3;
...
uint8_t* ExitResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.ExitResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.ExitResponse)
  return target;
}

size_t ExitResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.ExitResponse)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ExitResponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ExitResponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ExitResponse::GetClassData() const { return &_class_data_; }


void ExitResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ExitResponse*>(&to_msg);
  auto& from = static_cast<const ExitResponse&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.ExitResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.ExitResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ExitResponse::InternalSwap(ExitResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ExitResponse, _impl_.success_)
      + sizeof(ExitResponse::_impl_.success_)
      - PROTOBUF_FIELD_OFFSET(ExitResponse, _impl_.errcode_)>(
          reinterpret_cast<char*>(&_impl_.errcode_),
          reinterpret_cast<char*>(&other->_impl_.errcode_));
}
...
void UserServiceRpc::Exit(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::ExitRequest*,
                         ::fixbug::ExitResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method Exit() not implemented.");
  done->Run();
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    ...
    case 1:
      Exit(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::ExitRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::ExitResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::ExitRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::ExitResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::ExitRequest*
Arena::CreateMaybeMessage< ::fixbug::ExitRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::ExitRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::fixbug::ExitResponse*
Arena::CreateMaybeMessage< ::fixbug::ExitResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::ExitResponse >(arena);
}
